...
# the bellow code is broken. I am returning the correct number but still getting the answer
# incorrect. please fix your code before expecting students to solve it.
...
describe "using_delete" do 
  it "takes in two arguments, an array and a string, and uses the delete method to remove any items from the array that are equal to that string" do
    ...
    expect(instructors).to include("Steven")
  end
end
